...
/**
  * SquirrelMail CAPTCHA Plugin Meezerk Captcha Backend
  * Copyright (c) 2004-2007 Daniel Foster <dan_software@meezerk.com>
...
/**
  ...
  *
  */
function meezerk_check_configuration()
{
...
/**
  ...
  *
  */
function meezerk_show_input_widgets()
{
   ...
   if (check_sm_version(1, 5, 2))
   {
      $image_source = sqm_baseuri() 
                    . 'plugins/captcha/backends/meezerk/captcha-1.5.2plus.php?sq=' . time();

      global $oTemplate;
      $oTemplate->assign('image_source', $image_source);
      $output = $oTemplate->fetch('plugins/captcha/meezerk.tpl');
   }
   ...
   else
   {
      ...
      $image_source = sqm_baseuri() 
                    . 'plugins/captcha/backends/meezerk/captcha.php?sq=' . time();
...
/**
  ...
  *
  */
function meezerk_validate_captcha()
{
