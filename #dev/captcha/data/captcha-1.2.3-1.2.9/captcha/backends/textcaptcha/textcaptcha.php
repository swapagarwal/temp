...
/**
  ...
  *
  */
function textcaptcha_check_configuration()
{
...
/**
  ...
  *
  */
function textcaptcha_show_input_widgets()
{
   ...
   if (check_sm_version(1, 5, 2))
   {
      $image_source = sqm_baseuri() 
                    . 'plugins/captcha/backends/textcaptcha/image_generator-1.5.2plus.php?sq=' . time();

      global $oTemplate;
      $oTemplate->assign('image_source', $image_source);
      $output = $oTemplate->fetch('plugins/captcha/textcaptcha.tpl');
   }
   ...
   else
   {
      ...
      $image_source = sqm_baseuri() 
                    . 'plugins/captcha/backends/textcaptcha/image_generator.php?sq=' . time();
...
/**
  ...
  *
  */
function textcaptcha_validate_captcha()
{
