...
// This is a value that MUST be changed before b2evo can
// be used.  It is used to prevent cracking of the CAPTCHA
// value based on the image name.
//
$secret_key = 'CHANGE THIS TO SOME CUSTOM (SECRET) VALUE';
...
//
$counter_filename = 'captcha_plugin_b2evo_backend_image_garbage_collector_counter.txt';


// Prefix of captcha image filenames
//
$filename_prefix = 'captcha_plugin_b2evo_backend_image_';
...
//
$TTF_folder = SM_PATH . 'plugins/captcha/backends/b2evo/b2evo_captcha_fonts/';
...
// You don't usually need to change this for use with SquirrelMail
//
$tempfolder = SM_PATH . 'plugins/captcha/backends/b2evo/images/';
...
$CAPTCHA_CONFIG = array('secret_key'=>$secret_key,'tempfolder'=>$tempfolder,'TTF_folder'=>$TTF_folder,'minchars'=>$minchars,'maxchars'=>$maxchars,'minsize'=>$minsize,'maxsize'=>$maxsize,'maxrotation'=>$maxrotation,'noise'=>$noise,'websafecolors'=>$websafecolors,'debug'=>$debug,'counter_filename'=>$counter_filename,'filename_prefix'=>$filename_prefix,'collect_garbage_after'=>$collect_garbage_after,'maxlifetime'=>$maxlifetime,'case_sensitive'=>$case_sensitive);
