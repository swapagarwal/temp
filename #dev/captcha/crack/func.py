...
def gray_crop(p,d,i,b):
    ...
    #commect doublepass to improve accuracy
    ...
    img=image
    coordinates,img=section()
    img.crop(coordinates[0]).save('output/'+dirList[i][0]+b[0]+'.png')

    img.crop(coordinates[1]).save('output/'+dirList[i][1]+b[1]+'.png')

    img.crop(coordinates[2]).save('output/'+dirList[i][2]+b[2]+'.png')

    img.crop(coordinates[3]).save('output/'+dirList[i][3]+b[3]+'.png')
    
    img.crop(coordinates[4]).save('output/'+dirList[i][4]+b[4]+'.png')
